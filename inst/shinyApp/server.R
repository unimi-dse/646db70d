  ...
  output$plot <- plotly::renderPlotly({
    ...
    #Plots candlestick graph#
      ...
      plotly::add_lines(x = historical$Date, y= historical$Open,
                line = list(width = 0.75), inherit = F, plotly::layout(xaxis = list (title = "Dates", zeroline = FALSE),
                                                                        yaxis = list(title = "Price"), plotly::plot_ly( x = historical$Date, type="candlestick",
